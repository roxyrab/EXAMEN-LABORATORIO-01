...
APlataformaAereo::APlataformaAereo()
{
	...
	tipoPlataforma = ETipoPlataforma::PLATAFORMA_AEREO;
...
void APlataformaAereo::BeginPlay()
{
	Super::BeginPlay();
}

void APlataformaAereo::Tick(float DeltaTime)
{
